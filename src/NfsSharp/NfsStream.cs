...
namespace NfsSharp
{
    ...
    /// </code>
    /// <para>
    /// Obtain an instance via <see cref="NfsClient.OpenFileAsync"/>,
    /// <see cref="NfsClient.OpenFileReadOnlyAsync"/>, or <see cref="NfsClient.CreateFileAsync"/>
    ...
    public sealed class NfsStream : Stream
    {
        ...
        /// was opened read-only via <see cref="NfsClient.OpenFileReadOnlyAsync"/>.
        /// </summary>
